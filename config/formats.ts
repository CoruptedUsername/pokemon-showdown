...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: ['Not in Mod', 'DNU AG', 'DNU Uber', 'Huge Power', 'Pure Power', 'Shadow Tag', 'Arena Trap', 'Baton Pass', 'Moody', 'Cute Charm', 'Hustle'],
		unbanlist: ['Assist'],
	},
	{
		...
		mod: "gen9dnu",
		ruleset: ['Standard NatDex', 'Mega Rayquaza Clause', 'Terastal Clause', 'Z-Move Clause'],
		banlist: ['Not in Mod', 'DNU AG', 'DNU Uber', 'DNU OU', 'DNU UUBL', 'Huge Power', 'Pure Power', 'Shadow Tag', 'Arena Trap', 'Baton Pass', 'Moody', 'Cute Charm', 'Hustle'],
		unbanlist: ['Assist'],
	},
	{
		...
		mod: "gen9dnu",
		ruleset: ['Standard NatDex', 'Mega Rayquaza Clause', 'Terastal Clause', 'Z-Move Clause'],
		banlist: ['Not in Mod', 'DNU AG', 'DNU Uber', 'DNU OU', 'DNU UUBL', 'DNU UU', 'DNU RUBL', 'Huge Power', 'Pure Power', 'Shadow Tag', 'Arena Trap', 'Baton Pass', 'Moody', 'Cute Charm', 'Hustle'],
	...
	},
	{
		...
		banlist: ['Not in the Mod', 'Huge Power', 'Pure Power'],
		unbanlist: ['Assist'],
	},
	{
	...
	},
	{
		...
		banlist: ['Not in Mod', 'DNU AG', 'Huge Power', 'Pure Power', 'Baton Pass'],
	...
	},
	{
		...
		mod: "gen9dnulegacy",
		ruleset: ['Standard NatDex', 'Mega Rayquaza Clause', 'Terastal Clause', 'Z-Move Clause'],
		banlist: ['Not in Mod', 'Huge Power', 'Pure Power', 'Shadow Tag', 'Arena Trap', 'Baton Pass', 'Moody'],
	},
	{
		name: "[Gen 9] Do Not Use RU Legacy",
		mod: "gen9dnulegacy",
		ruleset: ['Standard NatDex', 'Mega Rayquaza Clause', 'Terastal Clause', 'Z-Move Clause'],
		banlist: ['Not in Mod', 'DNU OU', 'DNU UUBL', 'DNU UU', 'DNU RUBL', 'Huge Power', 'Pure Power', 'Shadow Tag', 'Arena Trap', 'Baton Pass', 'Moody'],
	},
	{
	...
	},
	{
		...
		banlist: ['Not in Mod', 'Gorilla Tactics'],
	},
	{
