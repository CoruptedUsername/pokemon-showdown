...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		banlist: ['Vanilla', 'Last Respects', 'Moody', 'Quick Claw', 'King\'s Rock', 'Razor Fang', 'Shed Tail', 'Rage Fist', 'Booster Energy', 'TR00', 'TR29', 'TR51', 'TR68', 'TR82', 'Baton Pass', 'Rage Fist', 'Hidden Power'],
