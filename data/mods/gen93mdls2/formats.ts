export const Formats: import('../../../sim/dex-formats').CustomFormatList = {
	gen93mdraftleagues2w4: {
		...
		banlist: ['Moody', 'Baton Pass', 'Swagger', 'Flatter', 'move:Metronome', 'Last Respects', 'Shed Tail', 'Rage Fist',
			...
			'Illusion', 'Impostor', 'Innards Out', 'Intrepid Sword', 'Magic Bounce', 'Magnet Pull', 'Moody', 'Neutralizing Gas',
			'Orichalchum Pulse', 'Parental Bond', 'Poison Heal', 'Pure Power', 'Regenerator', 'Shadow Tag', 'Simple', 'Speed Boost',
			'Stakeout', 'Triage', 'Unburden', 'Water Bubble', 'Wonder Guard', 'Assist', 'Electrifiy', 'Take Heart'],
		section: "Three Musketeers",
		teambuilder: {
			defaultLevel: 100,
			tierType: "tier",
